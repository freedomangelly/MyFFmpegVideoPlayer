...
import com.liuy.myffmpegplayer.R;
...
public class FFmpegRender implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    public FFmpegRender(Context context) {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        Log.i("info","onSurfaceCreated 111");
        initRenderYUV();
        Log.i("info","onSurfaceCreated 222");
        initRenderMediaCodec();
        Log.i("info","onSurfaceCreated 333");
    }

    @Override
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        Log.i("info","onSurfaceChanged 111");
        GLES20.glViewport(0, 0, width, height);
        Log.i("info","onSurfaceChanged 222");
    }
